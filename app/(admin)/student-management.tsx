            ...
            <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.wizardBody} keyboardShouldPersistTaps="handled">
                ...
                <View>
                  ...
                  <Pressable style={styles.pickerField} onPress={() => setWfActionPicker(true)}>
                    {wfAction ? (
                      ...
                      <Text style={styles.pickerPlaceholder}>Choose action type…</Text>
                    )}
                    <Ionicons name="chevron-down" size={16} color="#6B7280" />
                  </Pressable>
                  <TextInput
                    style={[styles.reasonInput, styles.wfReason]}
                    placeholder="Reason / notes for this intervention…"
                    placeholderTextColor="#9CA3AF"
                    multiline
                    value={wfReason}
              ...
              {wfStep === 4 ? (
                <View style={styles.summaryBox}>
                  <SummaryRow
                    label="Action"
                    value={wfAction ? SUPPORT_ACTION_LABELS[wfAction] : "—"}
                  />
                  ...
                  />
                  <SummaryRow label="Reason" value={wfReason.trim() || "—"} last />
                  {wfBulk ? (
